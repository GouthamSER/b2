...
# Bot images & videos
PICS = (environ.get('PICS', 'https://ibb.co/YB0x3HG')).split()
...
SUPPORT_CHAT_ID = @im_goutham_josh
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "b2")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <em>File Name</em>: <code>Kᴜᴛᴛᴜ|{file_name}</code> <br><br>🖇 <em>File Size</em>: <code>{file_size}</code> <br><br><br>❤️‍🔥 <i>Movie Requests</i> - ||@wudixh|| ')
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", '')
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", '🏷 𝖳𝗂𝗍𝗅𝖾: <a href={url}>{title}</a> \n🔮 𝖸𝖾𝖺𝗋: {year} \n⭐️ 𝖱𝖺𝗍𝗂𝗇𝗀𝗌: {rating}/ 10  \n🎭 𝖦𝖾𝗇𝖾𝗋𝗌: {genres} \n\n🎊 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 [[Kuttu b2]](t.me/wudixh13)')
